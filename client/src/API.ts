...
export const addGroup = async (
  formData: IGroup
): Promise<AxiosResponse<ApiDataTypeGroup>> => {
  try {
...
export const getEndpoints = async (
  groupID: string
): Promise<AxiosResponse<ApiDataTypeEndpoint>> => {
  try {
...
export const getAllEndpoints = async (): Promise<
  AxiosResponse<ApiDataTypeEndpoint>
> => {
  try {
    const endpoints: AxiosResponse<ApiDataTypeEndpoint> = await axios.get(
...
export const deleteEndpoint = async (
  ...
  try {
    const deletedEndpoint: AxiosResponse<ApiDataTypeEndpoint> =
      await axios.delete(
